...
$data = mysqli_fetch_array($queryAmbilData);
    ...
    if(isset($_POST['update'])){
        ...
        $no_punggung = $_POST['no_punggung'];
            ...
            $query = mysqli_query($con,"UPDATE pemain SET nama='$nama', asal_negara='$asal_negara', posisi='$posisi', no_punggung='$no_punggung' WHERE id_pemain='$id_pemain'");
            if($query){
...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="mb-3">
            <label for="asal_negara" class="form-label">Negara Asal</label>
            <input type="text" class="form-control" id="exampleInputPassword1" name="asal_negara" value="<?php echo $data['asal_negara']; ?>">
        </div>
        <div class="mb-3">
